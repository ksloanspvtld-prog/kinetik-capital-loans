          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white">
                Business <span className="text-indigo-600">Loan</span>
              </h1>
              <p className="mt-4 text-slate-600 dark:text-slate-400 text-lg">
                Get business loans up to ₹10 Crore at attractive interest rates. Fast funding for business growth.
              </p>
              <ul className="mt-6 space-y-3 text-slate-600 dark:text-slate-400">
                <li className="flex items-start gap-3">
                  <span className="text-indigo-500 text-xl mt-0.5">✓</span>
                  <span>Loan amounts up to ₹10 Crore</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-500 text-xl mt-0.5">✓</span>
                  <span>Fast funding within 48 hours</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-indigo-500 text-xl mt-0.5">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-indigo-500 text-xl mt-0.5">✓</span>
                  <span>No collateral required for small businesses</span>
                </li>
              </ul>
